            ...
            for session_id, session in self.sessions.items():
                ...
                session_data[session_id] = {
                    ...
                    "gitlab_config": {
                        ...
                        "project_namespace": getattr(
                            gitlab_client, "project_namespace", ""
                        ),
    ...
    def _load_sessions(self):
        ...
        try:
            if not os.path.exists(self.persistence_file):
                logger.info(
                    "Session persistence file not found, starting with empty sessions"
                )
                return
            ...
            for session_id, data in session_data.items():
                ...
                if (
                    ...
                    if not success:
                        logger.warning(
                            f"Failed to restore GitLab connection for session {session_id}"
                        )
