        ...
        <div className="stat-card">
          ...
          <div className="stat-breakdown">
            <span className="stat-item">
              完了: {statistics.completedPoints}
            </span>
            <span className="stat-item">
              進捗: {statistics.pointCompletionRate}%
            </span>
          </div>
        </div>
      ...
      <div className="breakdown-section">
        <div className="breakdown-card">
          ...
          <div className="breakdown-list">
            {Object.entries(statistics.milestoneBreakdown).map(
              ([milestone, count]) => (
        ...
        <div className="breakdown-card">
          <h5>サービス別</h5>
          <div className="breakdown-list">
            {Object.entries(statistics.serviceBreakdown).map(
              ([service, count]) => (
        ...
        <div className="breakdown-card">
          <h5>ステータス別</h5>
          <div className="breakdown-list">
            {Object.entries(statistics.kanbanBreakdown).map(
              ([status, count]) => (
