...
export const PBLStatistics = ({ issues }: PBLStatisticsProps) => {
  ...
  const statistics = useMemo(() => {
    ...
    // 詳細統計の計算
    const serviceBreakdown = issues.reduce(
      (acc, issue) => {
    ...
    const milestoneBreakdown = issues.reduce(
      (acc, issue) => {
    ...
    const epicBreakdown = issues.reduce(
      (acc, issue) => {
    ...
    const kanbanBreakdown = issues.reduce(
      (acc, issue) => {
    ...
    const quarterBreakdown = issues.reduce(
      (acc, issue) => {
  ...
  const breakdownSections = [
    { key: 'service', title: 'Service', data: statistics.serviceBreakdown },
    {
      key: 'milestone',
      title: 'Milestone',
      data: statistics.milestoneBreakdown,
    },
  ...
  return (
    <div className="pbl-statistics">
      <button className="statistics-toggle" onClick={toggleStatistics}>
        ...
        <>
          ...
          <div className="main-stats">
            ...
            <div className="stat-card">
              ...
              <div className="stat-value">
                {statistics.pointCompletionRate}%
              </div>
          ...
          <div className="detailed-breakdown">
            ...
            >
              ...
              <span
                className={`expand-icon ${showDetailedStats ? 'expanded' : ''}`}
              >
                ▼
              </span>
            </button>
