 ...
 */
export const getOverlappingQuarters = (startDate: string, endDate: string): string[] => {
 ...
 */
export const fiscalQuarterToDateRange = (quarter: string): { start: Date; end: Date } => {
...
export const testQuarterConversion = () => {
  ...
  // Test other periods
  console.log('2025-04-01 〜 2025-06-30 quarters:', getOverlappingQuarters('2025-04-01', '2025-06-30'))
  console.log('2025-03-01 〜 2025-05-01 quarters:', getOverlappingQuarters('2025-03-01', '2025-05-01'))
}